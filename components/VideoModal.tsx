...
import { X, SkipForward, SkipBack, Play, Pause, ChevronRight, ChevronLeft, List, Volume2, VolumeX, Maximize, Minimize, Settings, Captions, Check, Globe } from 'lucide-react';
...
const VideoModal: React.FC<VideoModalProps> = ({ anime, onClose, userId }) => {
  ...
  }, [userId, anime.id, currentEpisodeIndex]);
